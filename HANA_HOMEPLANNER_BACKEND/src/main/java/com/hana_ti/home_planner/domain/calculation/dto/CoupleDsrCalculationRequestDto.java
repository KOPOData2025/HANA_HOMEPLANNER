...
@AllArgsConstructor
@Builder
public class CoupleDsrCalculationRequestDto {
    ...
    @DecimalMin(value = "0", message = "DSR 한도는 0% 이상이어야 합니다")
    @DecimalMax(value = "100", message = "DSR 한도는 100% 이하여야 합니다")
    private BigDecimal dsrLimit; // DSR 한도 (기본값: 40%)

    @NotBlank(message = "배우자 사용자 ID는 필수입니다")
    private String spouseUserId; // 배우자의 사용자 ID
