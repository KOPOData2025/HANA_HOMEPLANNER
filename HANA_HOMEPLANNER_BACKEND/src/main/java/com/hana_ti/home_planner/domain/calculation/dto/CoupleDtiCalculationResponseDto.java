...
@AllArgsConstructor
@Builder
public class CoupleDtiCalculationResponseDto {
    ...
    // 2. 부부 합계 기존 대출 정보
    private BigDecimal coupleExistingMortgageAnnualPayment; // 부부 합계 기존 주택담보대출 연간 원리금
    private BigDecimal coupleExistingOtherLoanAnnualInterest; // 부부 합계 기존 기타대출 연간 이자
    private BigDecimal coupleTotalExistingAnnualPayment; // 부부 합계 기존 대출 총 연간 상환액
    ...
    // 4. DTI 계산 결과
    private BigDecimal totalAnnualPayment; // 총 연간 상환액 (부부합계 기존 + 희망대출)
